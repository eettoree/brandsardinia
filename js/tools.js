...
// ─── MUSEI DATA ───────────────────────────────────────────────
const MUSEI_DATA = [
  { id:1, name:'Museo Archeologico Nazionale', city:'Cagliari', tipo:'archeologia', orari:'Mar–Dom 9:00–20:00', biglietto:'5 €', desc:'La più importante collezione di antichità sarde: bronzetti nuragici, ceramiche fenicie, gioielli romani. Imprescindibile per capire la civiltà nuragica e le culture che si sono succedute nell\'isola.', indirizzo:'Piazza Arsenale 1, Cagliari' },
...
const RISTORANTI_DATA = [
  ...
  { id:7,  name:'Ristorante Gallura', city:'Olbia (SS)', tipo:'pesce', fascia:'medio', michelin:false, desc:'Un classico di Olbia dal 1963. Cucina gallurese con influenze marine — pesce del giorno, aragosta, sa minestra gallurese. Ambiente familiare, servizio attento. Ottima selezione di Vermentino di Gallura.',                                                                         indirizzo:'Corso Umberto I 145, Olbia (SS)', tel:'+39 0789 24648', specialita:['Sa minestra gallurese','Aragosta','Pesce del giorno'] },
  ...
  { id:10, name:'Josto by Pierluigi Fais', city:'Cagliari', tipo:'tipico', fascia:'medio', michelin:false, desc:'La cantina gastronomica più interessante di Cagliari — cicchetti sardi, piatti condivisi, vini naturali. Pierluigi Fais ha reinventato la cucina locale con leggerezza e ironia. Sempre pieno, prenotare.',                                                                      indirizzo:'Via Baylle 48, Cagliari', tel:'+39 070 7346857', specialita:['Cicchetti sardi','Crudi di pesce','Vini naturali'] },
...
const PRODOTTI_DATA = [
  ...
  { id:3,  name:'Pecorino Sardo',                categoria:'gastronomia', zona:'Sardegna intera',              cert:'DOP',   desc:'Il formaggio simbolo della Sardegna — "dolce" (20-60 gg) morbido e lattico, "maturo" (oltre 2 mesi) asciutto e piccante. Solo latte di pecora sarda. Fondamentale in ogni tavola isolana.',                                                       dove:'Caseifici, mercati, botteghe alimentari' },
  { id:4,  name:'Cannonau di Sardegna',          categoria:'vini',        zona:'Ogliastra / Barbagia',         cert:'DOC',   desc:'Il re dei vini sardi — Grenache con oltre 3.000 anni di storia. Rosso potente (min. 12.5%), ricco di polifenoli. Studiato come segreto della longevità degli ogliastrini. Tre sottotipi: Classico, Oliena, Capo Ferrato.',           dove:'Cantine, enoteche, online' },
  { id:5,  name:'Vermentino di Gallura',         categoria:'vini',        zona:'Gallura (SS)',                 cert:'DOCG',  desc:'L\'unica DOCG della Sardegna — bianco secco, profumo floreale, sapore fresco con leggera nota amaricante finale. Perfetto con aragosta e pesce. Prodotto solo in Gallura, nel nord-est dell\'isola.',                                    dove:'Cantine di Gallura, enoteche' },
  ...
  { id:7,  name:'Mirto Sardo',                   categoria:'liquori',     zona:'Sardegna intera',              cert:'PAT',   desc:'Il liquore delle bacche di mirto selvatico raccolte a mano da novembre a dicembre. Versione rossa (bacche mature) intensa e speziata, versione bianca (fiori) più delicata. Il digestivo dell\'isola.',                                  dove:'Distillerie artigianali, botteghe, aeroporto' },
  ...
  { id:9,  name:'Miele di Corbezzolo',           categoria:'gastronomia', zona:'Sardegna intera',              cert:'PAT',   desc:'Unico al mondo — amaro in entrata con retrogusto dolce e balsamico. Prodotto solo in Sardegna e Corsica dalle fioriture autunnali (ott-nov). Il miele di asfodelo (primavera) è invece delicato e quasi bianco.',                         dove:'Apicoltori, mercati, botteghe artigianali' },
  ...
  { id:11, name:'Coltello Pattada (Resolza)',    categoria:'artigianato', zona:'Pattada (SS)',                 cert:'PAT',   desc:'Il coltello più famoso della Sardegna — lama a "foglia di mirto" in acciaio, manico in corno di muflone. Ogni maestro pattadese firma il proprio pezzo. Collezionato in tutto il mondo.',                                              dove:'Laboratori a Pattada, fiere artigianato' },
