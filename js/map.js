...
// allMarkers/clusterDivMarkers/scIndex: rimossi (sistema nativo MapLibre)
...
const SARDINIA_CITIES_LABELS = {
  ...
  features: [
    // Tier 1 — capoluoghi e città principali (>40k ab.) — visibili da zoom 5.5
    ...
    // Tier 2 — comuni medi (8k–40k ab.) — visibili da zoom 7.8
    { type:'Feature', properties:{ name:'Alghero',              tier:2 }, geometry:{ type:'Point', coordinates:[8.3135,40.5585] } },
    { type:'Feature', properties:{ name:'Porto Torres',         tier:2 }, geometry:{ type:'Point', coordinates:[8.4014,40.8380] } },
    ...
    { type:'Feature', properties:{ name:'Selargius',            tier:2 }, geometry:{ type:'Point', coordinates:[9.1606,39.2575] } },
    { type:'Feature', properties:{ name:'Assemini',             tier:2 }, geometry:{ type:'Point', coordinates:[8.9706,39.2867] } },
    { type:'Feature', properties:{ name:'Sestu',                tier:2 }, geometry:{ type:'Point', coordinates:[9.0989,39.3018] } },
    { type:'Feature', properties:{ name:'Sinnai',               tier:2 }, geometry:{ type:'Point', coordinates:[9.2076,39.2991] } },
    ...
    { type:'Feature', properties:{ name:'Guspini',              tier:2 }, geometry:{ type:'Point', coordinates:[8.6294,39.5399] } },
    { type:'Feature', properties:{ name:'San Gavino Monreale',  tier:2 }, geometry:{ type:'Point', coordinates:[8.7876,39.5530] } },
    { type:'Feature', properties:{ name:"Sant'Antioco",         tier:2 }, geometry:{ type:'Point', coordinates:[8.4563,39.0678] } },
    { type:'Feature', properties:{ name:'Ozieri',               tier:2 }, geometry:{ type:'Point', coordinates:[9.0041,40.5858] } },
    { type:'Feature', properties:{ name:'Sorso',                tier:2 }, geometry:{ type:'Point', coordinates:[8.5779,40.7997] } },
    { type:'Feature', properties:{ name:'Ittiri',               tier:2 }, geometry:{ type:'Point', coordinates:[8.5627,40.5937] } },
    // Tier 3 — borghi e comuni (2k–8k ab.) — visibili da zoom 9.2
    ...
    { type:'Feature', properties:{ name:'Orosei',               tier:3 }, geometry:{ type:'Point', coordinates:[9.7006,40.3783] } },
    { type:'Feature', properties:{ name:'Golfo Aranci',         tier:3 }, geometry:{ type:'Point', coordinates:[9.6213,41.0003] } },
    { type:'Feature', properties:{ name:'Carloforte',           tier:3 }, geometry:{ type:'Point', coordinates:[8.3127,39.1434] } },
    { type:'Feature', properties:{ name:'Teulada',              tier:3 }, geometry:{ type:'Point', coordinates:[8.7289,38.9690] } },
    { type:'Feature', properties:{ name:'Isili',                tier:3 }, geometry:{ type:'Point', coordinates:[9.1108,39.7427] } },
    { type:'Feature', properties:{ name:'Senorbì',              tier:3 }, geometry:{ type:'Point', coordinates:[9.1397,39.5361] } },
    { type:'Feature', properties:{ name:'Dolianova',            tier:3 }, geometry:{ type:'Point', coordinates:[9.1800,39.3760] } },
    { type:'Feature', properties:{ name:'Mandas',               tier:3 }, geometry:{ type:'Point', coordinates:[9.1268,39.6582] } },
    { type:'Feature', properties:{ name:'Seui',                 tier:3 }, geometry:{ type:'Point', coordinates:[9.3267,39.8366] } },
    { type:'Feature', properties:{ name:'Perdasdefogu',         tier:3 }, geometry:{ type:'Point', coordinates:[9.4374,39.6784] } },
    { type:'Feature', properties:{ name:'Tertenia',             tier:3 }, geometry:{ type:'Point', coordinates:[9.5900,39.7048] } },
    { type:'Feature', properties:{ name:'Bari Sardo',           tier:3 }, geometry:{ type:'Point', coordinates:[9.6483,39.8367] } },
    { type:'Feature', properties:{ name:'Villagrande Strisaili',tier:3 }, geometry:{ type:'Point', coordinates:[9.5127,39.9372] } },
    { type:'Feature', properties:{ name:'Gairo',                tier:3 }, geometry:{ type:'Point', coordinates:[9.4913,39.8497] } },
    { type:'Feature', properties:{ name:'Laconi',               tier:3 }, geometry:{ type:'Point', coordinates:[9.0545,39.8556] } },
    { type:'Feature', properties:{ name:'Buddusò',              tier:3 }, geometry:{ type:'Point', coordinates:[9.2576,40.5668] } },
    { type:'Feature', properties:{ name:'Bitti',                tier:3 }, geometry:{ type:'Point', coordinates:[9.3782,40.4777] } },
    { type:'Feature', properties:{ name:'Galtellì',             tier:3 }, geometry:{ type:'Point', coordinates:[9.6238,40.3784] } },
    { type:'Feature', properties:{ name:'Posada',               tier:3 }, geometry:{ type:'Point', coordinates:[9.7064,40.6310] } },
    { type:'Feature', properties:{ name:'Orotelli',             tier:3 }, geometry:{ type:'Point', coordinates:[9.1462,40.1895] } },
    { type:'Feature', properties:{ name:'Ploaghe',              tier:3 }, geometry:{ type:'Point', coordinates:[8.7413,40.6643] } },
    { type:'Feature', properties:{ name:'Pattada',              tier:3 }, geometry:{ type:'Point', coordinates:[9.1167,40.5810] } },
    { type:'Feature', properties:{ name:'Nulvi',                tier:3 }, geometry:{ type:'Point', coordinates:[8.7388,40.7836] } },
    { type:'Feature', properties:{ name:'Sennori',              tier:3 }, geometry:{ type:'Point', coordinates:[8.6044,40.7960] } },
    { type:'Feature', properties:{ name:'Valledoria',           tier:3 }, geometry:{ type:'Point', coordinates:[8.8284,40.9338] } },
    { type:'Feature', properties:{ name:'Perfugas',             tier:3 }, geometry:{ type:'Point', coordinates:[8.8680,40.8415] } },
    { type:'Feature', properties:{ name:'Chiaramonti',          tier:3 }, geometry:{ type:'Point', coordinates:[8.8963,40.7705] } },
    { type:'Feature', properties:{ name:'Mores',                tier:3 }, geometry:{ type:'Point', coordinates:[8.8487,40.5444] } },
    { type:'Feature', properties:{ name:'Ardara',               tier:3 }, geometry:{ type:'Point', coordinates:[8.8198,40.6115] } },
    { type:'Feature', properties:{ name:'Fluminimaggiore',      tier:3 }, geometry:{ type:'Point', coordinates:[8.4977,39.3754] } },
    { type:'Feature', properties:{ name:'Arbus',                tier:3 }, geometry:{ type:'Point', coordinates:[8.5886,39.5319] } },
    { type:'Feature', properties:{ name:'Terralba',             tier:3 }, geometry:{ type:'Point', coordinates:[8.6367,39.7225] } },
    { type:'Feature', properties:{ name:'Mogoro',               tier:3 }, geometry:{ type:'Point', coordinates:[8.7804,39.6862] } },
    { type:'Feature', properties:{ name:'Ales',                 tier:3 }, geometry:{ type:'Point', coordinates:[8.8235,39.7682] } },
    { type:'Feature', properties:{ name:'Samugheo',             tier:3 }, geometry:{ type:'Point', coordinates:[9.0025,40.0003] } },
    { type:'Feature', properties:{ name:'Ghilarza',             tier:3 }, geometry:{ type:'Point', coordinates:[8.8379,40.1247] } },
    { type:'Feature', properties:{ name:'Abbasanta',            tier:3 }, geometry:{ type:'Point', coordinates:[8.8236,40.1265] } },
    { type:'Feature', properties:{ name:'Paulilatino',          tier:3 }, geometry:{ type:'Point', coordinates:[8.8780,40.0714] } },
    // Tier 4 — paesi (<2k ab.) — visibili da zoom 10.8
    ...
    { type:'Feature', properties:{ name:'Uta',                  tier:4 }, geometry:{ type:'Point', coordinates:[8.9626,39.2939] } },
    { type:'Feature', properties:{ name:'Decimomannu',          tier:4 }, geometry:{ type:'Point', coordinates:[8.9649,39.3126] } },
    { type:'Feature', properties:{ name:'Siliqua',              tier:4 }, geometry:{ type:'Point', coordinates:[8.8145,39.2965] } },
    { type:'Feature', properties:{ name:'Villaspeciosa',        tier:4 }, geometry:{ type:'Point', coordinates:[8.9319,39.3406] } },
    { type:'Feature', properties:{ name:'Narcao',               tier:4 }, geometry:{ type:'Point', coordinates:[8.6961,39.1715] } },
    { type:'Feature', properties:{ name:'Villamassargia',       tier:4 }, geometry:{ type:'Point', coordinates:[8.6431,39.2665] } },
    { type:'Feature', properties:{ name:'Buggerru',             tier:4 }, geometry:{ type:'Point', coordinates:[8.4010,39.4001] } },
    { type:'Feature', properties:{ name:'Escalaplano',          tier:4 }, geometry:{ type:'Point', coordinates:[9.3571,39.6226] } },
    { type:'Feature', properties:{ name:'Musei',                tier:4 }, geometry:{ type:'Point', coordinates:[8.5851,39.2869] } },
    { type:'Feature', properties:{ name:'Nuxis',                tier:4 }, geometry:{ type:'Point', coordinates:[8.6885,39.1289] } },
    { type:'Feature', properties:{ name:'Calasetta',            tier:4 }, geometry:{ type:'Point', coordinates:[8.3726,39.1077] } },
    { type:'Feature', properties:{ name:'Cardedu',              tier:4 }, geometry:{ type:'Point', coordinates:[9.6528,39.8049] } },
    { type:'Feature', properties:{ name:'Lotzorai',             tier:4 }, geometry:{ type:'Point', coordinates:[9.6648,39.9720] } },
    { type:'Feature', properties:{ name:'Triei',                tier:4 }, geometry:{ type:'Point', coordinates:[9.6671,40.0582] } },
    { type:'Feature', properties:{ name:'Urzulei',              tier:4 }, geometry:{ type:'Point', coordinates:[9.5543,40.0968] } },
    { type:'Feature', properties:{ name:'Talana',               tier:4 }, geometry:{ type:'Point', coordinates:[9.5277,40.0379] } },
    { type:'Feature', properties:{ name:'Arzana',               tier:4 }, geometry:{ type:'Point', coordinates:[9.5216,39.9119] } },
    { type:'Feature', properties:{ name:'Osini',                tier:4 }, geometry:{ type:'Point', coordinates:[9.5040,39.7584] } },
    { type:'Feature', properties:{ name:'Esterzili',            tier:4 }, geometry:{ type:'Point', coordinates:[9.2559,39.7119] } },
    { type:'Feature', properties:{ name:'Orroli',               tier:4 }, geometry:{ type:'Point', coordinates:[9.2684,39.6893] } },
    { type:'Feature', properties:{ name:'Nurri',                tier:4 }, geometry:{ type:'Point', coordinates:[9.2236,39.7195] } },
    { type:'Feature', properties:{ name:'Serri',                tier:4 }, geometry:{ type:'Point', coordinates:[9.1568,39.7144] } },
    { type:'Feature', properties:{ name:'Villanova Tulo',       tier:4 }, geometry:{ type:'Point', coordinates:[9.1930,39.7626] } },
    { type:'Feature', properties:{ name:'Goni',                 tier:4 }, geometry:{ type:'Point', coordinates:[9.2179,39.6627] } },
    { type:'Feature', properties:{ name:'Gesturi',              tier:4 }, geometry:{ type:'Point', coordinates:[9.0337,39.7356] } },
    { type:'Feature', properties:{ name:'Setzu',                tier:4 }, geometry:{ type:'Point', coordinates:[9.0001,39.7130] } },
    { type:'Feature', properties:{ name:'Tuili',                tier:4 }, geometry:{ type:'Point', coordinates:[8.9698,39.7219] } },
    { type:'Feature', properties:{ name:'Lunamatrona',          tier:4 }, geometry:{ type:'Point', coordinates:[8.9311,39.6717] } },
    { type:'Feature', properties:{ name:'Villamar',             tier:4 }, geometry:{ type:'Point', coordinates:[9.0029,39.6188] } },
    { type:'Feature', properties:{ name:'Serramanna',           tier:4 }, geometry:{ type:'Point', coordinates:[8.9207,39.4219] } },
    { type:'Feature', properties:{ name:'San Sperate',          tier:4 }, geometry:{ type:'Point', coordinates:[9.0173,39.3620] } },
    { type:'Feature', properties:{ name:'Monastir',             tier:4 }, geometry:{ type:'Point', coordinates:[9.0445,39.3749] } },
    { type:'Feature', properties:{ name:'Nuraminis',            tier:4 }, geometry:{ type:'Point', coordinates:[9.0049,39.4505] } },
    { type:'Feature', properties:{ name:'Pabillonis',           tier:4 }, geometry:{ type:'Point', coordinates:[8.7433,39.6135] } },
    { type:'Feature', properties:{ name:'Gonnosfanadiga',       tier:4 }, geometry:{ type:'Point', coordinates:[8.6659,39.4934] } },
    { type:'Feature', properties:{ name:'Villacidro',           tier:4 }, geometry:{ type:'Point', coordinates:[8.7412,39.4567] } },
    { type:'Feature', properties:{ name:'Samassi',              tier:4 }, geometry:{ type:'Point', coordinates:[8.8983,39.4924] } },
    { type:'Feature', properties:{ name:'Serrenti',             tier:4 }, geometry:{ type:'Point', coordinates:[9.0042,39.4952] } },
    { type:'Feature', properties:{ name:'Guasila',              tier:4 }, geometry:{ type:'Point', coordinates:[9.0530,39.5472] } },
    { type:'Feature', properties:{ name:'Ortacesus',            tier:4 }, geometry:{ type:'Point', coordinates:[9.1144,39.5056] } },
    { type:'Feature', properties:{ name:'Gesico',               tier:4 }, geometry:{ type:'Point', coordinates:[9.1283,39.5711] } },
    { type:'Feature', properties:{ name:'Suelli',               tier:4 }, geometry:{ type:'Point', coordinates:[9.1663,39.5625] } },
    { type:'Feature', properties:{ name:'Silius',               tier:4 }, geometry:{ type:'Point', coordinates:[9.3230,39.4983] } },
    { type:'Feature', properties:{ name:'Ballao',               tier:4 }, geometry:{ type:'Point', coordinates:[9.3596,39.5323] } },
    { type:'Feature', properties:{ name:'San Nicola Gerrei',    tier:4 }, geometry:{ type:'Point', coordinates:[9.3107,39.4596] } },
    { type:'Feature', properties:{ name:'Armungia',             tier:4 }, geometry:{ type:'Point', coordinates:[9.3850,39.5117] } },
    { type:'Feature', properties:{ name:'Villasalto',           tier:4 }, geometry:{ type:'Point', coordinates:[9.4120,39.5476] } },
    { type:'Feature', properties:{ name:'Maracalagonis',        tier:4 }, geometry:{ type:'Point', coordinates:[9.2300,39.3150] } },
    { type:'Feature', properties:{ name:'Burcei',               tier:4 }, geometry:{ type:'Point', coordinates:[9.3492,39.3520] } },
    { type:'Feature', properties:{ name:'Castiadas',            tier:4 }, geometry:{ type:'Point', coordinates:[9.4989,39.2340] } },
    { type:'Feature', properties:{ name:'Porto Giunco',         tier:4 }, geometry:{ type:'Point', coordinates:[9.5197,39.1246] } },
    { type:'Feature', properties:{ name:'Arborea',              tier:4 }, geometry:{ type:'Point', coordinates:[8.5793,39.7743] } },
    { type:'Feature', properties:{ name:'Marrubiu',             tier:4 }, geometry:{ type:'Point', coordinates:[8.6555,39.7434] } },
    { type:'Feature', properties:{ name:'Uras',                 tier:4 }, geometry:{ type:'Point', coordinates:[8.7074,39.6955] } },
    { type:'Feature', properties:{ name:'Santa Giusta',         tier:4 }, geometry:{ type:'Point', coordinates:[8.6104,39.8770] } },
    { type:'Feature', properties:{ name:'Palmas Arborea',       tier:4 }, geometry:{ type:'Point', coordinates:[8.6355,39.8558] } },
    { type:'Feature', properties:{ name:'Simaxis',              tier:4 }, geometry:{ type:'Point', coordinates:[8.7101,39.9149] } },
    { type:'Feature', properties:{ name:'Zerfaliu',             tier:4 }, geometry:{ type:'Point', coordinates:[8.7422,39.9421] } },
    { type:'Feature', properties:{ name:'Ollastra',             tier:4 }, geometry:{ type:'Point', coordinates:[8.7628,39.9670] } },
    { type:'Feature', properties:{ name:'Siamaggiore',          tier:4 }, geometry:{ type:'Point', coordinates:[8.6884,39.9118] } },
    { type:'Feature', properties:{ name:'Riola Sardo',          tier:4 }, geometry:{ type:'Point', coordinates:[8.5332,39.9965] } },
    { type:'Feature', properties:{ name:'Nurachi',              tier:4 }, geometry:{ type:'Point', coordinates:[8.5524,39.9728] } },
    { type:'Feature', properties:{ name:'Solarussa',            tier:4 }, geometry:{ type:'Point', coordinates:[8.6600,39.9539] } },
    { type:'Feature', properties:{ name:'Zeddiani',             tier:4 }, geometry:{ type:'Point', coordinates:[8.6350,39.9646] } },
    { type:'Feature', properties:{ name:'Tramatza',             tier:4 }, geometry:{ type:'Point', coordinates:[8.7040,39.9856] } },
    { type:'Feature', properties:{ name:'Milis',                tier:4 }, geometry:{ type:'Point', coordinates:[8.6386,40.0543] } },
    { type:'Feature', properties:{ name:'San Vero Milis',       tier:4 }, geometry:{ type:'Point', coordinates:[8.5898,40.0197] } },
    { type:'Feature', properties:{ name:'Narbolia',             tier:4 }, geometry:{ type:'Point', coordinates:[8.5697,40.0627] } },
    { type:'Feature', properties:{ name:'Cuglieri',             tier:4 }, geometry:{ type:'Point', coordinates:[8.5656,40.1849] } },
    { type:'Feature', properties:{ name:'Seneghe',              tier:4 }, geometry:{ type:'Point', coordinates:[8.6090,40.0947] } },
    { type:'Feature', properties:{ name:'Bonarcado',            tier:4 }, geometry:{ type:'Point', coordinates:[8.6637,40.0952] } },
    { type:'Feature', properties:{ name:'Santu Lussurgiu',      tier:4 }, geometry:{ type:'Point', coordinates:[8.6475,40.1404] } },
    { type:'Feature', properties:{ name:'Scano di Montiferro',  tier:4 }, geometry:{ type:'Point', coordinates:[8.5869,40.2103] } },
    { type:'Feature', properties:{ name:'Tresnuraghes',         tier:4 }, geometry:{ type:'Point', coordinates:[8.5213,40.2468] } },
    { type:'Feature', properties:{ name:'Magomadas',            tier:4 }, geometry:{ type:'Point', coordinates:[8.4936,40.2514] } },
    { type:'Feature', properties:{ name:'Modolo',               tier:4 }, geometry:{ type:'Point', coordinates:[8.4892,40.2701] } },
    { type:'Feature', properties:{ name:'Flussio',              tier:4 }, geometry:{ type:'Point', coordinates:[8.5116,40.2657] } },
    { type:'Feature', properties:{ name:'Suni',                 tier:4 }, geometry:{ type:'Point', coordinates:[8.5329,40.2823] } },
    { type:'Feature', properties:{ name:'Sagama',               tier:4 }, geometry:{ type:'Point', coordinates:[8.5628,40.2596] } },
    { type:'Feature', properties:{ name:'Tinnura',              tier:4 }, geometry:{ type:'Point', coordinates:[8.5414,40.2725] } },
    { type:'Feature', properties:{ name:'Montresta',            tier:4 }, geometry:{ type:'Point', coordinates:[8.4979,40.3292] } },
    { type:'Feature', properties:{ name:'Padria',               tier:4 }, geometry:{ type:'Point', coordinates:[8.7044,40.6367] } },
    { type:'Feature', properties:{ name:'Thiesi',               tier:4 }, geometry:{ type:'Point', coordinates:[8.7213,40.5251] } },
    { type:'Feature', properties:{ name:'Bonnanaro',            tier:4 }, geometry:{ type:'Point', coordinates:[8.7766,40.5050] } },
    { type:'Feature', properties:{ name:'Siligo',               tier:4 }, geometry:{ type:'Point', coordinates:[8.7350,40.5734] } },
    { type:'Feature', properties:{ name:'Bessude',              tier:4 }, geometry:{ type:'Point', coordinates:[8.7519,40.5521] } },
    { type:'Feature', properties:{ name:'Banari',               tier:4 }, geometry:{ type:'Point', coordinates:[8.7584,40.5300] } },
    { type:'Feature', properties:{ name:'Cossoine',             tier:4 }, geometry:{ type:'Point', coordinates:[8.7941,40.4929] } },
    { type:'Feature', properties:{ name:'Semestene',            tier:4 }, geometry:{ type:'Point', coordinates:[8.8159,40.4616] } },
    { type:'Feature', properties:{ name:'Borutta',              tier:4 }, geometry:{ type:'Point', coordinates:[8.7843,40.4820] } },
    { type:'Feature', properties:{ name:'Cheremule',            tier:4 }, geometry:{ type:'Point', coordinates:[8.7664,40.4685] } },
    { type:'Feature', properties:{ name:'Giave',                tier:4 }, geometry:{ type:'Point', coordinates:[8.8244,40.4303] } },
    { type:'Feature', properties:{ name:'Mara',                 tier:4 }, geometry:{ type:'Point', coordinates:[8.7543,40.4516] } },
    { type:'Feature', properties:{ name:'Olmedo',               tier:4 }, geometry:{ type:'Point', coordinates:[8.3833,40.6500] } },
    { type:'Feature', properties:{ name:'Uri',                  tier:4 }, geometry:{ type:'Point', coordinates:[8.4834,40.6437] } },
    { type:'Feature', properties:{ name:'Tissi',                tier:4 }, geometry:{ type:'Point', coordinates:[8.4618,40.6215] } },
    { type:'Feature', properties:{ name:'Usini',                tier:4 }, geometry:{ type:'Point', coordinates:[8.5326,40.6515] } },
    { type:'Feature', properties:{ name:'Muros',                tier:4 }, geometry:{ type:'Point', coordinates:[8.5889,40.6784] } },
    { type:'Feature', properties:{ name:'Ossi',                 tier:4 }, geometry:{ type:'Point', coordinates:[8.5777,40.6619] } },
    { type:'Feature', properties:{ name:'Florinas',             tier:4 }, geometry:{ type:'Point', coordinates:[8.6363,40.6777] } },
    { type:'Feature', properties:{ name:'Cargeghe',             tier:4 }, geometry:{ type:'Point', coordinates:[8.6170,40.7094] } },
    { type:'Feature', properties:{ name:'Osilo',                tier:4 }, geometry:{ type:'Point', coordinates:[8.6720,40.7475] } },
    { type:'Feature', properties:{ name:'Tergu',                tier:4 }, geometry:{ type:'Point', coordinates:[8.7582,40.8485] } },
    { type:'Feature', properties:{ name:'Laerru',               tier:4 }, geometry:{ type:'Point', coordinates:[8.8796,40.8028] } },
    { type:'Feature', properties:{ name:'Martis',               tier:4 }, geometry:{ type:'Point', coordinates:[8.9144,40.7922] } },
    { type:'Feature', properties:{ name:'Bulzi',                tier:4 }, geometry:{ type:'Point', coordinates:[8.9303,40.8207] } },
    ...
    { type:'Feature', properties:{ name:'Ala dei Sardi',        tier:4 }, geometry:{ type:'Point', coordinates:[9.0409,40.6590] } },
    { type:'Feature', properties:{ name:'Loiri Porto San Paolo',tier:4 }, geometry:{ type:'Point', coordinates:[9.5390,40.8520] } },
    { type:'Feature', properties:{ name:'Padru',                tier:4 }, geometry:{ type:'Point', coordinates:[9.3682,40.7698] } },
    { type:'Feature', properties:{ name:'Orune',                tier:4 }, geometry:{ type:'Point', coordinates:[9.3832,40.3776] } },
    { type:'Feature', properties:{ name:'Lula',                 tier:4 }, geometry:{ type:'Point', coordinates:[9.4838,40.4577] } },
    { type:'Feature', properties:{ name:'Irgoli',               tier:4 }, geometry:{ type:'Point', coordinates:[9.6507,40.4084] } },
    { type:'Feature', properties:{ name:'Onifai',               tier:4 }, geometry:{ type:'Point', coordinates:[9.6637,40.4461] } },
    { type:'Feature', properties:{ name:'Torpè',                tier:4 }, geometry:{ type:'Point', coordinates:[9.6763,40.6008] } },
    { type:'Feature', properties:{ name:'Lodè',                 tier:4 }, geometry:{ type:'Point', coordinates:[9.5545,40.5792] } },
    { type:'Feature', properties:{ name:'Bono',                 tier:4 }, geometry:{ type:'Point', coordinates:[9.0384,40.4147] } },
    { type:'Feature', properties:{ name:'Bultei',               tier:4 }, geometry:{ type:'Point', coordinates:[9.0686,40.4664] } },
    { type:'Feature', properties:{ name:'Anela',                tier:4 }, geometry:{ type:'Point', coordinates:[9.0547,40.5005] } },
    { type:'Feature', properties:{ name:'Benetutti',            tier:4 }, geometry:{ type:'Point', coordinates:[9.0920,40.5193] } },
    { type:'Feature', properties:{ name:'Nule',                 tier:4 }, geometry:{ type:'Point', coordinates:[9.1173,40.4778] } },
    { type:'Feature', properties:{ name:'Burgos',               tier:4 }, geometry:{ type:'Point', coordinates:[8.9977,40.3726] } },
    { type:'Feature', properties:{ name:'Bottidda',             tier:4 }, geometry:{ type:'Point', coordinates:[9.0106,40.3407] } },
    { type:'Feature', properties:{ name:'Olzai',                tier:4 }, geometry:{ type:'Point', coordinates:[9.1617,40.2099] } },
    { type:'Feature', properties:{ name:'Oniferi',              tier:4 }, geometry:{ type:'Point', coordinates:[9.1818,40.2536] } },
    { type:'Feature', properties:{ name:'Orani',                tier:4 }, geometry:{ type:'Point', coordinates:[9.1814,40.2376] } },
    { type:'Feature', properties:{ name:'Sarule',               tier:4 }, geometry:{ type:'Point', coordinates:[9.1700,40.2022] } },
    { type:'Feature', properties:{ name:'Ottana',               tier:4 }, geometry:{ type:'Point', coordinates:[9.0387,40.2301] } },
    { type:'Feature', properties:{ name:'Bolotana',             tier:4 }, geometry:{ type:'Point', coordinates:[8.9714,40.3196] } },
    { type:'Feature', properties:{ name:'Bortigali',            tier:4 }, geometry:{ type:'Point', coordinates:[8.9298,40.2829] } },
    { type:'Feature', properties:{ name:'Sindia',               tier:4 }, geometry:{ type:'Point', coordinates:[8.6729,40.2827] } },
    { type:'Feature', properties:{ name:'Birori',               tier:4 }, geometry:{ type:'Point', coordinates:[8.8736,40.3108] } },
    { type:'Feature', properties:{ name:'Dualchi',              tier:4 }, geometry:{ type:'Point', coordinates:[8.8945,40.2526] } },
    { type:'Feature', properties:{ name:'Lei',                  tier:4 }, geometry:{ type:'Point', coordinates:[8.9124,40.2245] } },
    { type:'Feature', properties:{ name:'Noragugume',           tier:4 }, geometry:{ type:'Point', coordinates:[8.9454,40.2132] } },
    { type:'Feature', properties:{ name:'Silanus',              tier:4 }, geometry:{ type:'Point', coordinates:[8.9049,40.3026] } },
    { type:'Feature', properties:{ name:'Borore',               tier:4 }, geometry:{ type:'Point', coordinates:[8.9014,40.2194] } },
    { type:'Feature', properties:{ name:'Nughedu San Nicolò',   tier:4 }, geometry:{ type:'Point', coordinates:[9.0044,40.5498] } },
    { type:'Feature', properties:{ name:'Illorai',              tier:4 }, geometry:{ type:'Point', coordinates:[9.0080,40.3897] } },
    { type:'Feature', properties:{ name:'Esporlatu',            tier:4 }, geometry:{ type:'Point', coordinates:[9.0266,40.3625] } },
    { type:'Feature', properties:{ name:'Neoneli',              tier:4 }, geometry:{ type:'Point', coordinates:[8.9853,40.0763] } },
    { type:'Feature', properties:{ name:'Busachi',              tier:4 }, geometry:{ type:'Point', coordinates:[8.9330,40.0426] } },
    { type:'Feature', properties:{ name:'Allai',                tier:4 }, geometry:{ type:'Point', coordinates:[9.0059,40.0267] } },
    { type:'Feature', properties:{ name:'Asuni',                tier:4 }, geometry:{ type:'Point', coordinates:[9.0107,39.9437] } },
    { type:'Feature', properties:{ name:'Nureci',               tier:4 }, geometry:{ type:'Point', coordinates:[9.0178,39.8834] } },
    { type:'Feature', properties:{ name:'Gadoni',               tier:4 }, geometry:{ type:'Point', coordinates:[9.1570,39.8951] } },
    { type:'Feature', properties:{ name:'Atzara',               tier:4 }, geometry:{ type:'Point', coordinates:[9.0985,40.0007] } },
    { type:'Feature', properties:{ name:'Teti',                 tier:4 }, geometry:{ type:'Point', coordinates:[9.1384,40.0678] } },
    { type:'Feature', properties:{ name:'Tiana',                tier:4 }, geometry:{ type:'Point', coordinates:[9.1589,40.0877] } },
    { type:'Feature', properties:{ name:'Ula Tirso',            tier:4 }, geometry:{ type:'Point', coordinates:[8.9126,40.1240] } },
    { type:'Feature', properties:{ name:'Sorgono',              tier:4 }, geometry:{ type:'Point', coordinates:[9.1001,40.0288] } },
    { type:'Feature', properties:{ name:'Meana Sardo',          tier:4 }, geometry:{ type:'Point', coordinates:[9.1755,39.9603] } },
    { type:'Feature', properties:{ name:'Tonara',               tier:4 }, geometry:{ type:'Point', coordinates:[9.1710,39.9993] } },
  ]
};
...
// ─── POI LAYERS — MapLibre native GeoJSON + GPU circle layers ─────────────
// Nessun DOM marker: tutto via WebGL. Zero reflow, zero compositing overhead.

function initPOILayers() {
  if (sardMap.getSource('pois')) return;

  sardMap.addSource('pois', {
    type: 'geojson',
  ...
  const POI_COLOR_EXPR = ['match', ['get', 'cat'],
    'spiaggia',   '#00BFFF',
    'città', '#8899bb',
    'hotel',      '#C8102E',
    'ristorante', '#FF8C00',
  ...
  // Glow cluster
  sardMap.addLayer({ id: 'poi-cluster-glow', type: 'circle', source: 'pois',
    filter: ['has', 'point_count'], layout: { visibility: 'none' },
    paint: { 'circle-color': 'rgba(0,180,216,0.18)', 'circle-blur': 0.7,
      'circle-radius': ['step', ['get', 'point_count'], 28, 10, 36, 50, 44] }
  });

  // Cerchi cluster
  sardMap.addLayer({ id: 'poi-clusters', type: 'circle', source: 'pois',
    filter: ['has', 'point_count'], layout: { visibility: 'none' },
    paint: { 'circle-color': 'rgba(0,180,216,0.88)',
      'circle-stroke-width': 2.5, 'circle-stroke-color': 'rgba(255,255,255,0.5)',
  ...
  sardMap.addLayer({ id: 'poi-glow', type: 'circle', source: 'pois',
    filter: ['!', ['has', 'point_count']], layout: { visibility: 'none' },
    paint: { 'circle-color': POI_COLOR_EXPR, 'circle-radius': 17,
  ...
  sardMap.on('click', 'poi-clusters', (e) => {
    e.originalEvent.stopPropagation();
    _suppressMapClick = true;
    const feat = e.features[0];
    sardMap.getSource('pois').getClusterExpansionZoom(feat.properties.cluster_id, (err, zoom) => {
      if (!err) sardMap.easeTo({ center: feat.geometry.coordinates, zoom: Math.min(zoom + 0.5, 18), duration: 500 });
    });
    setTimeout(() => { _suppressMapClick = false; }, 200);
  });

  // Click su pin singolo — apri quick card
  sardMap.on('click', 'poi-unclustered', (e) => {
    e.originalEvent.stopPropagation();
    _suppressMapClick = true;
    const poi = MAP_POI.find(p => p.id === e.features[0].properties.id);
    if (poi) { hideHoverTooltip(); showQuickCard(poi); }
    setTimeout(() => { _suppressMapClick = false; }, 100);
  });

  // Hover tooltip su pin singolo
  sardMap.on('mouseenter', 'poi-unclustered', (e) => {
    sardMap.getCanvas().style.cursor = 'pointer';
    if (!e.features || !e.features.length) return;
    const poi = MAP_POI.find(p => p.id === e.features[0].properties.id);
    if (poi) showHoverTooltip(poi, e.point);
  });
  sardMap.on('mouseleave', 'poi-unclustered', () => {
    sardMap.getCanvas().style.cursor = '';
    hideHoverTooltip();
  });
  sardMap.on('mouseenter', 'poi-clusters', () => { sardMap.getCanvas().style.cursor = 'pointer'; });
  sardMap.on('mouseleave', 'poi-clusters', () => { sardMap.getCanvas().style.cursor = ''; });
}

// Aggiorna GeoJSON source con il filtro categoria attivo
function updatePoisSource() {
...
function setPOILayersVisibility(visible) {
  ...
  POI_LAYER_IDS.forEach(id => {
    if (sardMap.getLayer(id)) sardMap.setLayoutProperty(id, 'visibility', vis);
  });
}

function showHoverTooltip(poi, point) {
...
function togglePins() {
  ...
  if (sardMap) {
    setPOILayersVisibility(pinsVisible);
    if (pinsVisible) updatePoisSource();
  }
}
...
function setActiveMapFilter(cat) {
  ...
  if (!pinsVisible) {
    pinsVisible = true;
    const btn = document.getElementById('pin-toggle-btn');
    if (btn) { btn.classList.add('active'); btn.querySelector('span').textContent = t('map.pins.hide'); }
  }
  if (sardMap && sardMap.getSource('pois')) {
    updatePoisSource();
    setPOILayersVisibility(true);
  }
  closeQuickCard();
  closeMapInfoPanel();
}
...
function showMapInfoPanel(poi) {
  ...
  const catLabel = getCatLabel(poi.cat) || poi.cat;
  ...
  const photoHTML = photoData
    ? `<div class="panel-photo">
         ...
         ${photoData.credit ? `<span class="panel-photo-credit" title="${photoData.credit}">${photoData.credit}</span>` : ''}
  ...
  if (poi.web) {
    const webFirst = String(poi.web).split(/\s*[·|,]\s*/)[0].trim();
    const webUrl = webFirst.startsWith('http') ? webFirst : `https://${webFirst}`;
    const webDisplay = webFirst.replace(/^https?:\/\//, '');
